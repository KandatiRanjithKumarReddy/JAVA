public class Object_Cloning {
    public static void main(String[] args) throws CloneNotSupportedException {
        ...
        // System.out.println(s.passport);
        // //changed
        // copiedStudent.name="Kandati Ranjith Kumar Reddy";
        // copiedStudent.passport = new Passport("12345678901234567890");
        // System.out.println(copiedStudent.name);
        // System.out.println(copiedStudent.passport);

        copiedStudent.passport.passportNumber = "999";
