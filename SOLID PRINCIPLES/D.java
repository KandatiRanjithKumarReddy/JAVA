...
// Because of this, the Computer class does not need changes when a new keyboard is added.
// The keyboard object is given to the computer from outside.
// This makes the code more flexible and reusable.
// It also makes testing easier because different keyboard types can be used anytime.
// The main idea is to avoid hardcoding one specific object inside another class so the program becomes easier to manage and extend later.
